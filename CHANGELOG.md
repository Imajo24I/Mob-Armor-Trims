- Removed individual trim applying
  ...
  - Replaced custom trim combinations with predefined trims
    ...
    - The new predefined trims system will, while a lot less flexible and configurable, be actually viable to use
- Use the same trim material for the mob's equipment as for the mob's armor
- Removed pattern blacklist
  - There is no use-case from the user side that I'm aware of. The default of blacklisting `trimtools` trim patterns has now been hardcoded into the mod
