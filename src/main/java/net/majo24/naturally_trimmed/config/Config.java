...
public class Config {
    ...
    @Entry(name = "enableTrimMobs", comment = "If enabled, the mod will try to apply trims to the equipment of mobs when they're newly spawning.")
    public boolean enableTrimMobs = true;

    @Entry(name = "enableTrimLootTables", comment = """
    ...
    @Entry(name = "enableTrimTrades", comment = """
    ...
    @SubConfig(name = "trimFiltering", comment = "Settings for determining/filtering which trims can be used by the mod")
    public TrimFilteringSubConfig trimFiltering = new TrimFilteringSubConfig();

    @SubConfig(name = "trimMobs", comment = "Settings for trimming a mob's equipment")
    public TrimMobsSubConfig trimMobs = new TrimMobsSubConfig();

    @SubConfig(name = "trimLootTables", comment = "Settings for trimming equipment generated by loot tables")
    public TrimLootTablesSubConfig trimLootTables = new TrimLootTablesSubConfig();

    @SubConfig(name = "trimTrades", comment = "Settings for trimming equipment from villager trades")
    public TrimTradesSubConfig trimTrades = new TrimTradesSubConfig();

    // === Sub Configs ===

    public static class TrimFilteringSubConfig {
        @Entry(name = "textureValidationFiltering", comment = """
        ...
        @Entry(name = "vanillaOnly", comment = "Use only vanilla trim materials and patterns")
        public boolean vanillaOnly = false;

        @Entry(name = "materialFilter", comment = """
        ...
        @Entry(name = "patternFilter", comment = """
    ...
    public static class TrimMobsSubConfig {
        ...
        @Entry(name = "noTrimsChance", comment = "Chance of the mob having no trims at all")
        public int noTrimsChance = 25;

        @Entry(name = "trimChance", comment = "Chance of each equipment piece having a trim applied. Applies individually to each armor piece.")
        public int trimChance = 75;

        @Entry(name = "predefinedTrims", comment = """
    ...
    public static class TrimLootTablesSubConfig {
        @Entry(name = "trimChance", comment = "Chance of an item generated by a loot table having a trim applied")
        public int trimChance = 50;
    }

    public static class TrimTradesSubConfig {
        @Entry(name = "trimChance", comment = "Chance of an item from a villager trade having a trim applied")
        public int trimChance = 50;

        @Entry(name = "minLevel", comment = "The minimum villager trading level an item needs to be in, to be considered of being trimmed")
