...
public class ToolTrimsCompat {
    ...
    public static void toolTrimsCompat(LivingEntity entity) {
        ...
        if (!mainhand.isEmpty() && mainhand.is(TRIMMABLE_TOOL_TAG)) {
            Pair<Registry<TrimMaterial>, Registry<TrimPattern>> registries = TrimApplier.getTrimRegistries(entity.registryAccess());
            ...
            TrimApplier.applyTrim(mainhand, trim, entity.registryAccess());
        }
    }
